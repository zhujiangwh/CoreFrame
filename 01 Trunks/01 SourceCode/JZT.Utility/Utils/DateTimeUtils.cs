...
namespace JZT.Utility.Utils
{
    public static class DateTimeUtils
    {
        ...
        #region 根据英文的星期几返回中文的星期几#region 根据英文的星期几返回中文的星期几
        ...
        public static string ConvertSecondToTime(double seconds)
        {
            double h = (int)Math.Floor(seconds / 3600.0);
            int m = (int)((seconds - 3600.0 * h) / 60.0);
            int s = (int)((seconds - 3600.0 * h) % 60.0);
