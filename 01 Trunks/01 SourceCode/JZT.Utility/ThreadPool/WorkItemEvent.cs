...
namespace JZT.Utility.ThreadPool
{
   /// <summary>
   ...
   public class WorkItemEventArgs : EventArgs
   {
      ...
      /// <summary>
      ///   Gets the <see cref="JZT.Utility.ThreadPool.WorkItem"/> associated with the event.
      /// </summary>
      /// <value>
      ///   The <see cref="JZT.Utility.ThreadPool.WorkItem"/> that caused the event.
      /// </value>
