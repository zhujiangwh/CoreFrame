...
namespace Core.DB.NHibernate
{
    public class NHiberanteService : IDisposable
    {
        ...
        private DBServerL DBServerL;

        public NHiberanteService()
        {
            DBServerL = DBServerL.GetInstance();
        }
        ...
        public ISession GetSession()
        {
            if (Session == null)
            {
                Session = DBServerL.DefaultDBServer.NHiberanteConfig.GetSession();
            }
            return Session;
        }
        ...
        public DataTable GetDataTable(string sql )
        {
            ...
            //string s = "  Provider=SQLOLEDB; ;Data source=vmxp; Initial Catalog=Core; User Id=sa;Password=gambol;Min Pool Size=5;Max Pool Size=50 ";
            ...
            //SqlConnection con = NHService.GetSession().Connection  as System.Data.SqlClient.SqlConnection;
            //SqlDataAdapter da = new SqlDataAdapter(selectObjectUIC.SqlScript.Sql, con);
            //DataTable table = new DataTable(); ;
            //da.Fill(table);
